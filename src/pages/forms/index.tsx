...
export function FormListPage(props: FormListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getForms({
        relations: ['organization', 'field.count', 'response.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('field', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'field',
          header: 'Field',
          accessorKey: 'field',
          cell: ({ row: { original: record } }: any) => record?._count?.field,
        }
      : null,
